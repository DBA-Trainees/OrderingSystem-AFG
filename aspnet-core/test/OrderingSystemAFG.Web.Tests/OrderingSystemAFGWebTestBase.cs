...
{
    public abstract class OrderingSystemAFGWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static OrderingSystemAFGWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(OrderingSystemAFGWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<OrderingSystemAFGDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<OrderingSystemAFGDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<OrderingSystemAFGDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<OrderingSystemAFGDbContext, Task<T>> func)
        {
            T result;
