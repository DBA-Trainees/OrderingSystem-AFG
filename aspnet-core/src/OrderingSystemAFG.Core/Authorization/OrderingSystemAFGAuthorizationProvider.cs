    ...
    public class OrderingSystemAFGAuthorizationProvider : AuthorizationProvider
    {
        ...
        public override void SetPermissions(IPermissionDefinitionContext context)
        {
            ...
            var vendorView = context.GetPermissionOrNull(PermissionNames.Pages_Users_Vendor) ?? context.CreatePermission(PermissionNames.Pages_Users_Vendor, L("Vendor Main Navigation"));
                ...
                vendorView.CreateChildPermission(PermissionNames.Pages_Vendor_Order_History, L("Vendor Order History View"));
                vendorView.CreateChildPermission(PermissionNames.Pages_Vendor_Reports, L("Vendor Reports View"));          
            #endregion
            ...
            #region Customer View
                ...
                customerView.CreateChildPermission(PermissionNames.Pages_Customers_Order_Report, L("Customer Order Report View"));
            #endregion
