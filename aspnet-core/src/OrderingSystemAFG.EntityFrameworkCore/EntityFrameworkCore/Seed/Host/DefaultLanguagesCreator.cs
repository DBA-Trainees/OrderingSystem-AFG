...
namespace OrderingSystemAFG.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = OrderingSystemAFGConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(OrderingSystemAFGDbContext context)
        {
            _context = context;
        }
