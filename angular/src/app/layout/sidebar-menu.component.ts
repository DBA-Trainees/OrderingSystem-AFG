    ...
    getMenuItems(): MenuItem[] {
        return [
            ...
            new MenuItem(this.l("VendorNav"), '', 'fas fa-store', 'Pages.User.Vendor', [
                ...
                new MenuItem(this.l('Order History'), '/app/vendor-order-history', 'fas fa-clock-rotate-left', 'Pages.Vendor.Order.History'),
                new MenuItem(this.l('Reports'), '/app/vendor-reports', 'fa fa-pie-chart', 'Pages.Vendor.Reports'), 
            ]),
            // #endregion
            ...
            new MenuItem(this.l("CustomerNav"), '', 'fas fa-user-friends', 'Pages.User.Customer', [
                ...
                new MenuItem(this.l('Reports'), '/app/customer-report', 'fa fa-pie-chart', 'Pages.Customers.Order.Report'),
            ]),
            // #endregion
