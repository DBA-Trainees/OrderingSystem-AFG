...
export class CategoryServiceProxy {
     ...
     * @return Success
     */
    getAllTheListOfCategoryFromDTO(): Observable<CategoryDto[]> {
        let url_ = this.baseUrl + "/api/services/app/Category/GetAllTheListOfCategoryFromDTO";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetAllTheListOfCategoryFromDTO(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetAllTheListOfCategoryFromDTO(response_ as any);
                } catch (e) {
    ...
    protected processGetAllTheListOfCategoryFromDTO(response: HttpResponseBase): Observable<CategoryDto[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
...
export class CustomerServiceProxy {
     ...
     * @return Success
     */
    getAllTheListOfCustomersIncludingDivisions(keyword: string | undefined, isActive: boolean | undefined, skipCount: number | undefined, maxResultCount: number | undefined): Observable<CustomerDtoPagedResultDto> {
        let url_ = this.baseUrl + "/api/services/app/Customer/GetAllTheListOfCustomersIncludingDivisions?";
        if (keyword === null)
            throw new Error("The parameter 'keyword' cannot be null.");
        else if (keyword !== undefined)
            url_ += "Keyword=" + encodeURIComponent("" + keyword) + "&";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetAllTheListOfCustomersIncludingDivisions(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetAllTheListOfCustomersIncludingDivisions(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<CustomerDtoPagedResultDto>;
                }
            } else
    ...
    protected processGetAllTheListOfCustomersIncludingDivisions(response: HttpResponseBase): Observable<CustomerDtoPagedResultDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
...
export class CustomerOrderServiceProxy {
     ...
     * @return Success
     */
    getAll(keyword: string | undefined, isActive: boolean | undefined, skipCount: number | undefined, maxResultCount: number | undefined): Observable<CustomerOrderDtoPagedResultDto> {
     ...
     * @return Success
     */
    putOrdersToCart(body: CustomerOrderDto | undefined): Observable<CustomerOrderDto> {
        let url_ = this.baseUrl + "/api/services/app/CustomerOrder/PutOrdersToCart";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("put", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processPutOrdersToCart(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processPutOrdersToCart(response_ as any);
                } catch (e) {
     ...
     * @return Success
     */
    getOrderByReferenceNumber(referenceNumber: string | undefined): Observable<CustomerOrderDto[]> {
        let url_ = this.baseUrl + "/api/services/app/CustomerOrder/GetOrderByReferenceNumber?";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetOrderByReferenceNumber(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetOrderByReferenceNumber(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<CustomerOrderDto[]>;
                }
            } else
    ...
    protected processGetOrderByReferenceNumber(response: HttpResponseBase): Observable<CustomerOrderDto[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            if (Array.isArray(resultData200)) {
                result200 = [] as any;
                for (let item of resultData200)
                    result200.push(CustomerOrderDto.fromJS(item));
            }
            else {
                result200 = <any>null;
            }
     ...
     * @return Success
     */
    getAllConfirmedOrdersCustomer(keyword: string | undefined, isActive: boolean | undefined, skipCount: number | undefined, maxResultCount: number | undefined): Observable<CustomerOrderDtoPagedResultDto> {
        let url_ = this.baseUrl + "/api/services/app/CustomerOrder/GetAllConfirmedOrdersCustomer?";
        if (keyword === null)
            throw new Error("The parameter 'keyword' cannot be null.");
        else if (keyword !== undefined)
            url_ += "Keyword=" + encodeURIComponent("" + keyword) + "&";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetAllConfirmedOrdersCustomer(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetAllConfirmedOrdersCustomer(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<CustomerOrderDtoPagedResultDto>;
                }
            } else
    ...
    protected processGetAllConfirmedOrdersCustomer(response: HttpResponseBase): Observable<CustomerOrderDtoPagedResultDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return Success
     */
    getPreviousOrderByReferenceNumber(referenceNumber: string | undefined): Observable<CustomerOrderDto[]> {
        let url_ = this.baseUrl + "/api/services/app/CustomerOrder/GetPreviousOrderByReferenceNumber?";
        if (referenceNumber === null)
            throw new Error("The parameter 'referenceNumber' cannot be null.");
        else if (referenceNumber !== undefined)
            url_ += "referenceNumber=" + encodeURIComponent("" + referenceNumber) + "&";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetPreviousOrderByReferenceNumber(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetPreviousOrderByReferenceNumber(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<CustomerOrderDto[]>;
                }
            } else
    ...
    protected processGetPreviousOrderByReferenceNumber(response: HttpResponseBase): Observable<CustomerOrderDto[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return Success
     */
    update(body: CustomerOrderDto | undefined): Observable<CustomerOrderDto> {
        let url_ = this.baseUrl + "/api/services/app/CustomerOrder/Update";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processUpdate(response: HttpResponseBase): Observable<CustomerOrderDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
...
export class DivisionServiceProxy {
     ...
     * @return Success
     */
    getAllTheListOfDivisionFromDTO(): Observable<DivisionDto[]> {
        let url_ = this.baseUrl + "/api/services/app/Division/GetAllTheListOfDivisionFromDTO";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetAllTheListOfDivisionFromDTO(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetAllTheListOfDivisionFromDTO(response_ as any);
                } catch (e) {
    ...
    protected processGetAllTheListOfDivisionFromDTO(response: HttpResponseBase): Observable<DivisionDto[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
...
export class FoodTypeServiceProxy {
     ...
     * @return Success
     */
    getAllTheListOfFoodTyoeFromDTO(): Observable<FoodTypeDto[]> {
        let url_ = this.baseUrl + "/api/services/app/FoodType/GetAllTheListOfFoodTyoeFromDTO";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetAllTheListOfFoodTyoeFromDTO(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetAllTheListOfFoodTyoeFromDTO(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<FoodTypeDto[]>;
                }
            } else
    ...
    protected processGetAllTheListOfFoodTyoeFromDTO(response: HttpResponseBase): Observable<FoodTypeDto[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
...
export class SizeServiceProxy {
     ...
     * @return Success
     */
    getAll(keyword: string | undefined, isActive: boolean | undefined, skipCount: number | undefined, maxResultCount: number | undefined): Observable<SizeDtoPagedResultDto> {
     ...
     * @return Success
     */
    getAllTheListOfSizeFromDTO(): Observable<SizeDto[]> {
        let url_ = this.baseUrl + "/api/services/app/Size/GetAllTheListOfSizeFromDTO";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetAllTheListOfSizeFromDTO(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetAllTheListOfSizeFromDTO(response_ as any);
                } catch (e) {
    ...
    protected processGetAllTheListOfSizeFromDTO(response: HttpResponseBase): Observable<SizeDto[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return Success
     */
    update(body: SizeDto | undefined): Observable<SizeDto> {
...
export class CreateCustomerOrderDto implements ICreateCustomerOrderDto {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.totalQuantityOfOrder = _data["totalQuantityOfOrder"];
    ...
    toJSON(data?: any) {
        ...
        data["totalQuantityOfOrder"] = this.totalQuantityOfOrder;
...
export class CustomerOrderDtoPagedResultDto implements ICustomerOrderDtoPagedResultDto {
    ...
    clone(): CustomerOrderDtoPagedResultDto {
        const json = this.toJSON();
        let result = new CustomerOrderDtoPagedResultDto();
        result.init(json);
        return result;
