...
export class CustomerOrderServiceProxy {
     ...
     * @return Success
     */
    updateStatusNumberIntoFour(body: CustomerOrderDto | undefined): Observable<CustomerOrderDto> {
        let url_ = this.baseUrl + "/api/services/app/CustomerOrder/UpdateStatusNumberIntoFour";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("put", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processUpdateStatusNumberIntoFour(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processUpdateStatusNumberIntoFour(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<CustomerOrderDto>;
                }
            } else
    ...
    protected processUpdateStatusNumberIntoFour(response: HttpResponseBase): Observable<CustomerOrderDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
